...
public class SubscriptionServiceImplTest {
    ...
    void subscribeOnInitOneBySub_whenSubscriptionIsExisted_thenThrowNewIncorrectDataException() {
        ...
        assertEquals("Error: subscription. Нельзя дважды подписаться на одного и того же инициатора", exp.getMessage());
    }
    ...
    void unSubscribeOnInitOneBySub_whenSubscriptionDoesNotExist_thenThrowNewIncorrectDataException() {
        ...
        assertEquals("Error: subscription. Невозможно отменить подписку если она не оформлена", exp.getMessage());
    }
